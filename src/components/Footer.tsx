    ...
    <footer className="bg-blue-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/quienes-somos`} className="text-blue-100 hover:text-white transition-colors">
                  {locale === 'en' ? 'About Us' : 'Quiénes Somos'}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-blue-100 mb-2">
              <strong>Email:</strong> info@transform-arte.com.mx
            </p>
            <p className="text-blue-100 mb-4">
            ...
            <form className="mt-4">
              <p className="text-blue-100 mb-2">
                {locale === 'en' ? 'Subscribe to our newsletter' : 'Suscríbete a nuestro boletín'}
              </p>
              <div className="flex">
                <input
                  type="email"
                  placeholder={locale === 'en' ? 'Your email' : 'Tu correo electrónico'}
        ...
        <div className="mt-8 pt-8 border-t border-blue-800 text-center text-blue-200">
          ...
          <p>© {new Date().getFullYear()} TransformArte. {locale === 'en' ? 'All rights reserved.' : 'Todos los derechos reservados.'}</p>
        </div>
      </div>
    </footer>
  );
