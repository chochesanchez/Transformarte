    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">TransformArte</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/proyecto" className="text-gray-300 hover:text-white">Proyecto</Link>
              </li>
              <li>
                <Link href="/quienes-somos" className="text-gray-300 hover:text-white">Quiénes Somos</Link>
              </li>
              <li>
                <Link href="/donar" className="text-gray-300 hover:text-white">Donar Obra</Link>
              </li>
              <li>
                <Link href="/catalogo" className="text-gray-300 hover:text-white">Catálogo</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">
              <strong>Email:</strong> info@transformarte.org
            </p>
            <p className="text-gray-300 mb-4">
              <strong>Teléfono:</strong> +52 (81) 1234 5678
            </p>
            <form className="mt-4">
              <p className="text-gray-300 mb-2">Suscríbete a nuestro boletín</p>
              <div className="flex">
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-r"
                >
                  Suscribir
                </button>
              </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>© {new Date().getFullYear()} TransformArte. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
